...
/* Functions for Bad Character Heuristic of Boyer Moore String Matching
 * Algorithm */
...
int main() {
    char txt[] = "AABAACAADAABAAABAAAABAACAADAABAAABAAAABAACAADAABAAABAABAACBA"
                 "DAABBAAAAB"
                 "AA"
                 "CAADAABAAABAAAABAACAADAABAAABAAAABAACAADAABAAABAAAABAACAADAA"
                 "BAAABAAAAB"
                 "AA"
                 "CAADAABAAABAAAABAACAADAABAAABAAAABAACAADAABAAABAAAABAACAADAA"
                 "BAAABAAAAB"
