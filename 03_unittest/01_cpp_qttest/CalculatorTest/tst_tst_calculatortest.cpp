...
void tst_calculatorTest::testAdd()
{
	QCOMPARE(add(2, 3), 5);
}

void tst_calculatorTest::testSubtract()
{
	QCOMPARE(subtract(2, 3), -1);
}

void tst_calculatorTest::testMultiply()
{
	QCOMPARE(multiply(2, 3), 6);
}
