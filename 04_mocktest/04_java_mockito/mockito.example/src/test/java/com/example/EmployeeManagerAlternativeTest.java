...
public class EmployeeManagerAlternativeTest {
	 ...
	 * This is especially useful when we can’t access the argument outside of the 
	...
	*/
	...
	/**
	 * Spy on a real object. This will allow us to call all the normal methods 
	 * of the object while still tracking every interaction, just as we would 
	 * with a mock.
	 */
	@Spy
