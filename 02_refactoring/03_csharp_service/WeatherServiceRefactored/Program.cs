...
using WeatherServiceRefactored.Services;

IWeatherService service = new OpenWeatherService(new WeatherHttpService());
// IWeatherService service = new OpenWeatherService(new TestHttpService());
